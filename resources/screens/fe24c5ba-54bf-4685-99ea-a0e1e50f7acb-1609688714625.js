jQuery("#simulation")
  .on("click", ".s-fe24c5ba-54bf-4685-99ea-a0e1e50f7acb .click", function(event, data) {
  ...
  .on("pageload", ".s-fe24c5ba-54bf-4685-99ea-a0e1e50f7acb .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
