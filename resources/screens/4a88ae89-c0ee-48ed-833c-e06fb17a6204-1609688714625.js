jQuery("#simulation")
  .on("click", ".s-4a88ae89-c0ee-48ed-833c-e06fb17a6204 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/45494372-1da3-4b71-9e1a-8732b0a34056",
                    "transition": {
                      "type": "fade",
                      "duration": 700
                    }
  ...
  .on("pageload", ".s-4a88ae89-c0ee-48ed-833c-e06fb17a6204 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
